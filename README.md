# Скрипт для обработки csv-файлов и составления сводного отчета
...
#### Пример консольного ввода параметров наименования отчета и перечня файлов для парсинга:
```
python main.py --report average-rating --files products1.csv products2.csv
```

#### Передача пользователем пути к директории с файлами:
```
Укажите путь к месту расположения файлов:
```

#### Пример консольного вывода сформированного отчета в виде таблицы:
```
average-rating
+----+---------+----------+
|    | brand   |   rating |
...
- обработка ввода пустых значений аргументов
...
#### В директории /examole_screens расположены скрины:
- примера запуска скрипта
- результатов тестирования
- показателей покрытия тестами
